...
<!--         <meta name="keywords" content="jquery, form, sliding, usability, css3, validation, javascript"/> -->
        <link rel="stylesheet" href="http://www.symfony.jobeet.lcl/js/sliding_form/css/style.css" type="text/css" media="screen"/>
		<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.4.2/jquery.min.js"></script>
        <script type="text/javascript" src="http://www.symfony.jobeet.lcl/js/sliding_form/sliding.form.js"></script>
    </head>
    <style>
        span.reference{
            position:fixed;
